...
public class EvaluationItem extends Box {
    public EvaluationItem(Datapoints.Courses course, Datapoints.Courses.Assignment evaluationMethod, Title title, JPanel assignmentPanel) {
    ...
    public EvaluationItem(Datapoints.Courses course, Datapoints.Courses.Exam evaluationMethod, Title title, JPanel assignmentPanel) {
        super(BoxLayout.X_AXIS);
        setAlignmentX(Component.LEFT_ALIGNMENT);
        Box line = new Line(new ListItem(
            evaluationMethod.title, 
