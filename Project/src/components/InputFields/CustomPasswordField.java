...
public class CustomPasswordField extends JPasswordField implements MouseListener, FocusListener, KeyListener {
	private static final long serialVersionUID = 1L;
    Boolean showPassword;
    private Color background = Colors.TEXT_FIELD_BACKGROUND;
    private Color border = Colors.TEXT_FIELD_BORDER;

    public CustomPasswordField(boolean showPassword) {
