...
public class Sizes {
    ...
    public static final Dimension DP_PROFILE_PAGE = new Dimension( 100, 100);
    ...
    public static class DIALOG{
        ...
        public static final Dimension PERSON = new Dimension((int) (Sizes.DEFAULT_WINDOW_SIZE.getWidth() / 2), (int) (Sizes.DEFAULT_WINDOW_SIZE.getHeight() / 1.3));
    }
